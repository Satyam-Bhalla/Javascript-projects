...
window.addEventListener("keypress",function key(){
	//if up arrow or w is pressed than move upward
	var key = event.keyCode;
	if (direction != -1 && (key == 119 || key == 87 || event.which == 38)) {
		direction = 0;
	}
	// S and down arrow to move downward
	...
	//press right arrow or d for moving right
